...
class PessoaFisica(Cliente):
    ...
    def __str__(self):
        return (
            f"Cliente PF: {self._nome} - CPF: {self._cpf} - Endereço: {self._endereco}"
        )
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if saque_invalido:
            ...
            print(
                f"O valor máximo permitido para saque é R$\t{self._limite_saque_diario:.2f}"
            )
        else:
            self._saldo -= valor
        ...
        while True:
            ...
            if opcao == 1:
                ...
                if tipo_cliente == "PF":
                    ...
                    endereco = input(
                        "Endereço: Formato: Logradouro, nro - bairro cidade / UF\t"
                    )
                    data = input("Data Nascimento:\t")
                    self.cadastrar_cliente(
                        tipo_cliente, documento, nome, endereco, data
                    )
                elif tipo_cliente == "PJ":
                ...
                if cliente:
                    ...
                    print(
                        f"{cliente.__str__} sua conta DIOBANK foi criada com sucesso!"
                    )
                else:
                    print(
                        "###### Cliente não encontrado, aproveite e se cadastre em nosso menu de opções! DIOBANK sempre com você ######"
                    )
            elif opcao == 3:
                print("\t\t######## DIOBANK Cadastro de Conta Corrente ########\t\t\n")
                documento_cliente = input("Digite o CPF ou CNPJ do cliente: ")
                ...
                print(
                    "\t\t######## DIOBANK Sistema de Deposito Bancário ########\t\t\n"
                )
                documento_cliente = input("Digite o CPF ou CNPJ do cliente: ")
                cliente = self.verificar_cliente(documento_cliente)
                if cliente:
                    ...
                    if conta:
                        ...
                        if valor > 0:
                            valida_deposito = input(
                                f"Confirma o deposito no valor de R$  {valor:.2f}"
                                + " Digite s para confirmar / n caso contrário: "
                            ).upper()
                ...
                print(
                    "######## Obrigado por utilizar o DIOBANK, até a próxima! ########"
                )
                break
            else:
